// Un arquero de fútbol desea saber si su promedio de tapadas es mayor a la media, 
// el programa le pedirá al usuario su promedio actual y el valor de la media actual.
// Si el promedio del arquero es mayor a la media se debe mostrar un mensaje por pantalla indicándolo. Para ello: 
...
// - Utilizando una estructura de control condicional simple, compara ambos valores y, en caso de el promedio del arquero ser MAYOR o
//     IGUAL a la media actual, muestra un mensaje en pantalla de felicitaciones.
